...
public class HashQP<E> extends HashTable<E>
{
	protected static final int ACTIVE = 0;
	   ...
	   // public methods ---------------------------------
	   public HashQP(int tableSize,Hasher<E> h, Comparator<E> c) // ADD Comparator<E> and Hasher<E> parameters for HW#5!!!!!!!!
	   {
	   ...
	   public HashQP(Hasher<E> h, Comparator<E> c)// ADD Comparator<E> and Hasher<E> parameters for HW#5!!!!!!!!
	   {
